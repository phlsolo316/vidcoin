...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/VIDCoin
else
  DOCKER_EXEC echo \> \$HOME/.vidcoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/vidcoin/vidcoin/pull/18288#discussion_r433189350 for
  # details.
