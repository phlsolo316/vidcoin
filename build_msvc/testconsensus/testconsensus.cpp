...
// vidcoin includes.
#include <..\src\script\vidcoinconsensus.h>
...
int main()
{
    std::cout << "vidcoinconsensus version: " << vidcoinconsensus_version() << std::endl;
    ...
    auto op0Result = vidcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, vidcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
