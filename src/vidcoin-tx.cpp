...
static void SetupVIDCoinTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " vidcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  vidcoin-tx [options] <hex-tx> [commands]  Update hex-encoded vidcoin transaction\n" +
            "or:     vidcoin-tx [options] -create [commands]   Create hex-encoded vidcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded vidcoin transaction
