...
#ifndef VIDCOIN_INTERFACES_NODE_H
#define VIDCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a vidcoin node (vidcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // VIDCOIN_INTERFACES_NODE_H
