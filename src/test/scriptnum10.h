...
#ifndef VIDCOIN_TEST_SCRIPTNUM10_H
#define VIDCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from VIDCoin Core 0.10.0, for cross-comparison.
 */
public:
