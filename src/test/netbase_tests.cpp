...
{
    BOOST_CHECK(TestSplitHost("www.vidcoincore.org", "www.vidcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.vidcoincore.org]", "www.vidcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.vidcoincore.org:80", "www.vidcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.vidcoincore.org]:80", "www.vidcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:36358", "127.0.0.1", 36358));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:36358", "127.0.0.1", 36358));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:36358", "::ffff:127.0.0.1", 36358));
    BOOST_CHECK(TestSplitHost("[::]:36358", "::", 36358));
    BOOST_CHECK(TestSplitHost("::36358", "::36358", -1));
    BOOST_CHECK(TestSplitHost(":36358", "", 36358));
    BOOST_CHECK(TestSplitHost("[]:36358", "", 36358));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:36358", "127.0.0.1:36358"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:36358", "[::]:36358"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
