...
#ifndef VIDCOIN_QT_GUIUTIL_H
#define VIDCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the VIDCoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "vidcoin:" URI into recipient object, return true on successful parsing
