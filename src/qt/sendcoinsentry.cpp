    ...
    platformStyle(_platformStyle)
{
    ...
    // normal vidcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying vidcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &VIDCoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
