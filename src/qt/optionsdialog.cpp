    ...
    mapper(nullptr)
{
    ...
    ui->vidcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->vidcoinAtStartup);
    ...
    ui->vidcoinAtStartup->setToolTip(ui->vidcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->vidcoinAtStartup->setText(ui->vidcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openVIDCoinConfButton->setToolTip(ui->openVIDCoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new VIDCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->vidcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openVIDCoinConfButton_clicked()
{
