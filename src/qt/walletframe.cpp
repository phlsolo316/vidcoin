...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, VIDCoinGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &VIDCoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &VIDCoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &VIDCoinGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &VIDCoinGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &VIDCoinGUI::updateWalletStatus);
    connect(gui, &VIDCoinGUI::setPrivacy, walletView, &WalletView::setPrivacy);
