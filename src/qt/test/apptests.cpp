...
//! Entry point for VIDCoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &VIDCoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for VIDCoinGUI tests.
void AppTests::guiTests(VIDCoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &VIDCoinGUI::consoleShown, this, &AppTests::consoleTests);
