...
#ifndef VIDCOIN_WALLET_WALLETUTIL_H
#define VIDCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! vidcoin from opening the wallet, thinking it was newly created, and
...
#endif // VIDCOIN_WALLET_WALLETUTIL_H
