...
#ifndef VIDCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define VIDCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The VIDCoin Core wallet was originally a collection of unrelated private
...
#endif // VIDCOIN_WALLET_SCRIPTPUBKEYMAN_H
