...
#ifndef VIDCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define VIDCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@vidcoin.
 *
 ...
 *
 * The chacha20-poly1305@vidcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@vidcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@vidcoin are relatively fast in
...
#endif // VIDCOIN_CRYPTO_CHACHA_POLY_AEAD_H
