...
#ifndef VIDCOIN_COMPAT_ASSUMPTIONS_H
#define VIDCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "VIDCoin cannot be compiled without assertions."
#endif
...
#endif // VIDCOIN_COMPAT_ASSUMPTIONS_H
