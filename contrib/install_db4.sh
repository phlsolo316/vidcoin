...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the vidcoin repository."
  exit 1
fi
...
# See https://github.com/vidcoin/vidcoin/issues/16064
...
echo 'When compiling vidcoind, run `./configure` in the following way:'
echo
