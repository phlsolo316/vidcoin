# Bootstrappable VIDCoin Core Builds

This directory contains the files necessary to perform bootstrappable VIDCoin
Core builds.
...
- 24GB of free disk space on the partition that the VIDCoin Core git repository
  resides in
...
For a VIDCoin Core depends development environment, simply invoke
...
From the top of a clean VIDCoin Core repository:
...
To use dongcarl's substitute server for VIDCoin Core builds after having
