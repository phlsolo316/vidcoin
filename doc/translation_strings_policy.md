...
This document provides guidelines for internationalization of the VIDCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `vidcoin_en.ts` remains unchanged.
