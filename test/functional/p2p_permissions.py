...
class P2PPermissionsTests(VIDCoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].vidcoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].vidcoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
