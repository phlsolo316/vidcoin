...
class TestShell:
    """Wrapper Class for VIDCoinTestFramework.

    The TestShell class extends the VIDCoinTestFramework
    ...
    class __TestShell(VIDCoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by VIDCoinTestFramework child class.
            self.num_nodes = 1
