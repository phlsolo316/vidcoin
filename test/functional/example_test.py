...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the VIDCoinTestFramework
    pass


class ExampleTest(VIDCoinTestFramework):
    # Each functional test is a subclass of the VIDCoinTestFramework class.
    ...
    def custom_method(self):
        ...
        VIDCoinTestFramework class so other tests can use it."""
