...
"""Verify that starting vidcoin with -h works as expected."""

from test_framework.test_framework import VIDCoinTestFramework
from test_framework.util import assert_equal

class HelpTest(VIDCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start vidcoin with -h for help text")
        ...
        self.log.info("Start vidcoin with -version for version information")
        ...
        self.log.info("Start vidcoind with -fakearg to make sure it does not start")
