...
By default, vidcoind will dump mempool on shutdown and
...
class MempoolPersistTest(VIDCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent vidcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
